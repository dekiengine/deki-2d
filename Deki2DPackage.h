...
/**
 * @file Deki2DPackage.h
 * @brief Central header for the Deki 2D Graphics Package
 *
 * This header includes all components of the 2D graphics package:
 ...
 *
 * This package can be disabled by commenting out DEKI_PACKAGE_2D in DekiTargets.h
 * If disabled, removing the packages/2d/ folder will not break the build.
 */
...
// Feature-level control: when DEKI_PACKAGE_FEATURES_CONFIGURED is set,
...
// declarations regardless of whether the consuming code has DEKI_PACKAGE_2D defined.
#ifdef DEKI_EDITOR
#include <string>
#include <cstdint>
